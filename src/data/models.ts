...
export const models: Model[] = [
  {
    ...
    huggingfaceUrl: 'https://huggingface.co/agibot-world',
    paperUrl: 'https://arxiv.org/pdf/2503.06669',
  ...
  //   githubUrl: 'https://github.com/OpenDriveLab/Agibot-World/genie-world-model',
  //   huggingfaceUrl: 'https://huggingface.co/agibot/genie-world-model',
  //   paperUrl: '/papers/genie-world-model.pdf',
  //   image: `${imgPath}images/machine_learning_climate_modeling_digital_twin_earth_diagram.jpg`,
  //   features: [
  ...
  //   githubUrl: 'https://github.com/OpenDriveLab/Agibot-World/embodied-controller',
  ...
  //   githubUrl: 'https://github.com/OpenDriveLab/Agibot-World/perception-engine',
  ...
  //   githubUrl: 'https://github.com/OpenDriveLab/Agibot-World/agibot-vlm',
  //   huggingfaceUrl: 'https://huggingface.co/agibot/agibot-vlm',
  //   paperUrl: '/papers/agibot-vlm.pdf',
  //   image: `${imgPath}images/transformer_neural_network_architecture_diagram_llm.jpg`,
  //   features: [
  ...
  //   githubUrl: 'https://github.com/OpenDriveLab/Agibot-World/agibot-rl',
